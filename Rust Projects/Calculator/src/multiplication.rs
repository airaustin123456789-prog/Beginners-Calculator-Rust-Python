...
pub fn multiplication_function() {
    ...
    println!("Please enter the first number to multiply from! ");
    ...
    .expect("Failed to get users first response!");
        ...
        // Creating the multiplication loop label!

        'multiplication_loop_label: loop{

        // Asking user for the second input!

            println!("");

            println!("Please enter the second number to multiply from! ");
            ...
            continue 'multiplication_loop_label;
        ...
        break 'multiplication_loop_label;

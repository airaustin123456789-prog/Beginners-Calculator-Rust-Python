...
pub fn subtraction_function() {
    ...
    println!("Please enter the first number to subtract from! ");
    ...
    .expect("Failed to get users first response!");
        ...
        // Creating the subtraction loop label!

        'subtraction_loop_label: loop{

        // Asking user for the second input!

            println!("");

            println!("Please enter the second number to subtract from! ");
            ...
            continue 'subtraction_loop_label

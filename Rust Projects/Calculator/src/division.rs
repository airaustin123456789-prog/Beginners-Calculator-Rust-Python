...
pub fn division_function() {
    ...
    println!("Please enter the first number to divide from! ");
    ...
    .expect("Failed to get users first response!");
        ...
        // Creating the division loop label!

        'division_loop_label: loop{

        // Asking user for the second input!

            println!("");

            println!("Please enter the second number to divide from! ");
